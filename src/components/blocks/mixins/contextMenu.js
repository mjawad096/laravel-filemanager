export default {
  computed: {
    ...
    isfirstItemDoc() {
      return this.selectedItems[0] && this.$store.state.fm.settings.docExtensions.includes(this.selectedItems[0].extension.toLowerCase());
    },
  },
  methods: {
    /**
    ...
    canView(extension) {
      ...
      || this.$store.state.fm.settings.docExtensions.includes(extension.toLowerCase());
    },
