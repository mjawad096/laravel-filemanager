    ...
    <div class="modal-content fm-modal-upload">
        ...
        <div class="modal-body">
            <div class="fm-btn-wrapper" v-show="!progressBar">
                <button type="button" class="btn btn-secondary btn-block" v-if="false">
                    {{ lang.btn.uploadSelect }}
                </button>
                <div class="dropbox" :class="{draggingFiles: draggingFiles}">
                    <p v-if="draggingFiles">Drop your file(s) here</p>
                    <p v-else>Drag & Drop your file(s) here or click to select</p>
...
export default {
  ...
  computed: {
    draggingFiles(){
      return this.$store.state.fm.modal.draggingFiles;
    },
...
<style lang="scss">
    .fm-modal-upload {
        .fm-btn-wrapper{
            ...
            .dropbox:hover, .dropbox.draggingFiles {
