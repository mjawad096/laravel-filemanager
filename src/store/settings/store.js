...
export default {
  ...
  state() {
    return {
      ...
      // axios default URL
      baseUrl: process.env.NODE_ENV == 'production' ? null : 'http://localhost/file-manager/',
      ...
      // Documents extensions for view and preview
      docExtensions: ['doc', 'docx', 'xls', 'xlsx', 'txt', 'pdf'],
